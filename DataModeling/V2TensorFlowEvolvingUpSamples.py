...
while predictionsGettingBetter:
    ...
    currentPredictionDifference0 = abs(findRightupSampleFunction(HOFupSampleTimes,\
    NoHOFupSampleTimes)- predictionGoal)

    currentPredictionDifference1 = abs(findRightupSampleFunction(HOFupSampleTimes+1,\
    NoHOFupSampleTimes)- predictionGoal)

    currentPredictionDifference2 = abs(findRightupSampleFunction(HOFupSampleTimes,\
    NoHOFupSampleTimes+1)- predictionGoal)

    if currentPredictionDifference0 <  currentPredictionDifference1 and \
    currentPredictionDifference0 <  currentPredictionDifference2:
        predictionsGettingBetter = False
                  
    else:
        if currentPredictionDifference2 <  currentPredictionDifference1:
...
0.2708333333333333
0 0 0.2532697706321832


print(str(HOFupSampleTimes)+" "+str(NoHOFupSampleTimes)+" "+ str(currentPredictionDifference0))
